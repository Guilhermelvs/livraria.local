...
if(
    ...
    if($erro == false){
        ...
        $livros->update($_POST['livro_id'], $add_data);
?>
...
<div class="container">
    <div class="single-sec">
        <div class="alert alert-success" role="alert" id="success_message" style="margin: 25px">
            ...
            <p>O livro foi atualizado corretamente!</p>
            <br />
            <a href="<?php echo URL_BASE; ?>painel/livro-lista" class="btn btn-warning btn-sm">Finalizar</a>
        </div>
    </div>
</div>
