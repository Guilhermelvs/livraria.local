...
<div id="wrapper">
	...
	<div id="page">
		<div id="content">
				<h1 class="title">Consultar e Atualizar Cadastro</a></h1>
				<?php require_once("ConsultarAtualizarCadastroNegocio.php"); ?>
		</div>
	...
	<!-- end #page -->
<div id="footer">
	<p>&copy; Professor Sidney Lima. Disciplina: Tópicos Integradores I</a>.</p>
</div>
<!-- end #footer -->
</div>
</body>
