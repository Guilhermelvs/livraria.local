...
<div id="wrapper">
	<div id="header">
		<div id="logo">
			<h1><a href="../index.php">T&oacute;picos Integradores I </a></h1>
		</div>
		<div id="search">
	...
	<div id="page">
		<div id="content">
				<h1 class="title">Consultar e Atualizar Livros</a></h1>
				<?php require_once("ConsultarAtualizarLivrosNegocio.php"); ?>
		</div>
