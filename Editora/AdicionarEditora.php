...
<form action="AdicionarDepartamentoCarrinho.php">
  Nome *:<br>
  <input type="text" name="nome" size="30">
  <br>
  Codigo da Editora*:<br>
  <input type="number" min="1" max="50000" name="Cod_edt">
  <br>
    País*:<br>
   <select name="cascata">
 ...
 <br>
  Cidade*:<br>
  <input type="text" name="nome" size="30" name= "End_edt">
  <br>
  CEP*:<br>
  <input type="text" name="nome" size="12" name= "End_edt">
  <br>
    Rua*:<br>
  <input type="text" name="nome" size="30" name= "End_edt">
  <br>
  ...
  Telefone*:<br>
  <input type="text" size="12" name="tel_edt">
  <br>
  <br>
